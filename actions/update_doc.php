...
if ($designation == "") {
    ...
    include('../dbconn.php');
    $sql_adddoc = "UPDATE doctor SET Title = '$title', FirstName = '$firstname', LastName = '$lastname', Telphone = '$tel', Address = '$address', Designation = '$designation', NIC = '$nic', Gender = '$gender' WHERE Doctor_Id = $doc_id";
