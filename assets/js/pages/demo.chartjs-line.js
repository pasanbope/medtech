function hexToRGB(t, e) {
	...
	return e ? "rgba(" + a + ", " + i + ", " + t + ", " + e + ")" : "rgb(" + a + ", " + i + ", " + t + ")"
}
...
function down(t, e) {
	...
	function t() {
		this.$body = a("body"), this.charts = [], this.defaultColors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]
	}
	t.prototype.interpolationExample = function() {
			...
			t = new Chart(t, {
				...
				data: {
					...
					datasets: [{
						...
						borderColor: e[0],
						fill: !0,
						backgroundColor: hexToRGB(e[0], .3)
					}, {
						label: "Small Radius",
			...
			t = new Chart(t, {
				...
				data: {
					...
					datasets: [{
						...
						backgroundColor: hexToRGB(e[1], .3),
						borderColor: e[1],
						borderWidth: 1.5,
						yAxisID: "y1"
					}]
					...
					datasets: [{
						...
						segment: {
							borderColor: function(t) {
								return skipped(t, "rgb(0,0,0,0.2)") || down(t, "rgb(192,75,75)")
							},
		...
		var e = this;
		Chart.defaults.font.family = '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif', Chart.defaults.color = "#8391a2", Chart.defaults.borderColor = "rgba(133, 141, 152, 0.1)", this.interpolationExample(), this.lineExample(), this.multiAxesExample(), this.pointStylingExample(), this.lineSegmentExample(), this.steppedExample(), a(window).on("resizeEnd", function(t) {
			a.each(e.charts, function(t, e) {
				try {
					e.destroy()
				} catch (t) {}
			}), e.interpolationExample(), e.lineExample(), e.multiAxesExample(), e.pointStylingExample(), e.lineSegmentExample(), e.steppedExample()
		}), a(window).resize(function() {
			this.resizeTO && clearTimeout(this.resizeTO), this.resizeTO = setTimeout(function() {
				a(this).trigger("resizeEnd")
			}, 500)
		})
	}, a.ChartJs = new t, a.ChartJs.Constructor = t
}(window.jQuery),
function() {
	"use strict";
