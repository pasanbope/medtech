function hexToRGB(t, a) {
	...
	return a ? "rgba(" + e + ", " + o + ", " + t + ", " + a + ")" : "rgb(" + e + ", " + o + ", " + t + ")"
}! function(e) {
	"use strict";

	function t() {
		this.$body = e("body"), this.charts = [], this.defaultColors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]
	}
	t.prototype.borderRadiusExample = function() {
			...
			t = new Chart(t, {
				...
				data: {
					...
					datasets: [{
						...
						borderColor: a[0],
						backgroundColor: hexToRGB(a[0], .3),
						borderWidth: 2,
						...
						backgroundColor: hexToRGB(a[1], .3),
						borderColor: a[1],
						borderWidth: 2,
						borderRadius: 5,
						borderSkipped: !1
		...
		var a = this;
		Chart.defaults.font.family = '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif', Chart.defaults.color = "#8391a2", Chart.defaults.borderColor = "rgba(133, 141, 152, 0.1)", this.borderRadiusExample(), this.floatingBarExample(), this.horizontalExample(), this.stackedExample(), this.groupStackedExample(), this.verticalExample(), e(window).on("resizeEnd", function(t) {
			e.each(a.charts, function(t, a) {
				try {
					a.destroy()
				} catch (t) {}
			}), a.borderRadiusExample(), a.floatingBarExample(), a.horizontalExample(), a.stackedExample(), a.groupStackedExample(), a.verticalExample()
		}), e(window).resize(function() {
			this.resizeTO && clearTimeout(this.resizeTO), this.resizeTO = setTimeout(function() {
				e(this).trigger("resizeEnd")
			}, 500)
		})
	}, e.ChartJs = new t, e.ChartJs.Constructor = t
}(window.jQuery),
function() {
	"use strict";
