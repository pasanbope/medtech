var colors = ["#727cf5", "#0acf97"],
	...
	colors = ((chart = new ApexCharts(document.querySelector("#multiple-yaxis-mixed"), options)).render(), ["#0acf97", "#fa5c7c"]),
	...
	colors = ((chart = new ApexCharts(document.querySelector("#line-area-mixed"), options)).render(), ["#727cf5", "#39afd1", "#fa5c7c"]),
